howlkraul.drops.Coin = function (x, y) {
  ...
  this.m_timers = this.application.scenes.selected.m_timers;
  this.m_lifespan = 10000;
  this.m_flickerTime = 2000;
  this.m_lifeSpanTimer = null;
  this.m_flickerTimer = null;
}
...
howlkraul.drops.Coin.prototype.dispose = function () {
  ...
  this.m_timers.remove(this.m_lifeSpanTimer);
  this.m_timers.remove(this.m_flickerTimer);
}
...
howlkraul.drops.Coin.prototype.m_setTimer = function () {
  this.m_lifeSpanTimer = this.m_timers.create({
    duration: this.m_lifespan - this.m_flickerTime,
    onComplete: this.m_expire,
    scope: this
  }, true)
}

howlkraul.drops.Coin.prototype.m_expire = function () {
