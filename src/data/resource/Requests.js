...
howlkraul.data.Requests.prototype.m_construct = function() {
	...
	this.add("continue_24x24", "./../asset/img/hud/deadscreen/continue_24x24.png");
	this.add("dead_background2_400x225", "./../asset/img/hud/deadscreen/dead_background2_400x225.png");
	this.add("dead_background_400x225", "./../asset/img/hud/deadscreen/dead_background_400x225.png");
	this.add("death_screen_218x152", "./../asset/img/hud/deadscreen/death_screen_218x152.png");
	this.add("blue_card_94x136", "./../asset/img/hud/deadscreen/player cards/blue_card_94x136.png");
	...
	this.add("sfx_hp_drink", "./../asset/sounds/sfx/drops/potion/sfx_hp_drink.mp3");
	this.add("sfx_hp_drink2", "./../asset/sounds/sfx/drops/potion/sfx_hp_drink2.mp3");
	...
	this.add("sfx_table_crash", "./../asset/sounds/sfx/furniture/table/sfx_table_crash.mp3");
	this.add("sfx_table_crash2", "./../asset/sounds/sfx/furniture/table/sfx_table_crash2.mp3");
	this.add("sfx_table_hit1", "./../asset/sounds/sfx/furniture/table/sfx_table_hit1.mp3");
	this.add("sfx_table_hit2", "./../asset/sounds/sfx/furniture/table/sfx_table_hit2.mp3");
	this.add("sfx_table_hit3", "./../asset/sounds/sfx/furniture/table/sfx_table_hit3.mp3");
	...
	this.add("sfx_spell2", "./../asset/sounds/sfx/projectiles/spell/sfx_spell2.mp3");
	this.add("sfx_wizard_dash", "./../asset/sounds/sfx/wizard/sfx_wizard_dash.mp3");
	this.add("sfx_wizard_death", "./../asset/sounds/sfx/wizard/sfx_wizard_death.mp3");
	this.add("sfx_wizard_death2", "./../asset/sounds/sfx/wizard/sfx_wizard_death2.mp3");
	this.add("sfx_wizard_hit1", "./../asset/sounds/sfx/wizard/sfx_wizard_hit1.mp3");
	this.add("sfx_wizard_hit2", "./../asset/sounds/sfx/wizard/sfx_wizard_hit2.mp3");
	this.add("sfx_wizard_hit3", "./../asset/sounds/sfx/wizard/sfx_wizard_hit3.mp3");
};