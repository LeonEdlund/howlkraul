howlkraul.entity.Archer = function (x, y) {
  howlkraul.entity.PlayableCharacter.call(this, x, y, 27, 34, "archer_27x34");

  this.power = 50;
  this.energyCost = 20;
}

howlkraul.entity.Archer.prototype = Object.create(howlkraul.entity.PlayableCharacter.prototype);
howlkraul.entity.Archer.prototype.constructor = howlkraul.entity.Archer;
 ...
 * @override
 */
howlkraul.entity.Archer.prototype.init = function () {
 ...
 * @overide
*/
howlkraul.entity.Archer.prototype.initAnimations = function () {
  // // IDLE
 ...
 * @overide
 */
howlkraul.entity.Archer.prototype.m_performAttack = function () {
